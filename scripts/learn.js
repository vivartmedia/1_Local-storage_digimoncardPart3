...
//     let wordsArray = word.split(splitOn);
//     let capitalizedWords = [];

//     // Loop through each substring
//     for (let i = 0; i < wordsArray.length; i++) {
//         // Take the first character, capitalize it, and concatenate with the rest of the substring
//         let capitalizedWord = wordsArray[i].charAt(0).toUpperCase() + wordsArray[i].slice(1);
//         capitalizedWords.push(capitalizedWord);
//     }

//     // Join the array of capitalized words with the joinWith delimiter
//     return capitalizedWords.join(joinWith);
// }
